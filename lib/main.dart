...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  OverlaySupport.global(
      child: MultiProvider(
       providers: [
         ChangeNotifierProvider<CommonViewModel>(create: (_)=> CommonViewModel()),
         ChangeNotifierProvider<DayCounter>(create: (_)=> DayCounter()),
         ChangeNotifierProvider<HotelViewModel>(create: (_)=> HotelViewModel()),
         ChangeNotifierProvider<HolidayPackageViewModel>(create: (_)=> HolidayPackageViewModel()),
         ChangeNotifierProvider<AuthViewModel>(create: (_)=> AuthViewModel()),
         ChangeNotifierProvider<AirLineViewModel>(create: (_)=> AirLineViewModel())
       ],
