...
class SingleAirlinesScreen extends StatelessWidget {
  String id;
  SingleAirlinesScreen({Key? key,required this.id}) : super(key: key);
  static const String routeName = "/single-airlines";

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<SingleHotelViewModel>(
        create: (_) => SingleHotelViewModel(), child: SingleAirlinesBody(id: id,));
  }
}

class SingleAirlinesBody extends StatefulWidget {
  String id;
  SingleAirlinesBody({Key? key,required this.id}) : super(key: key);
                    ...
                    onPressed: () {
                      showDialog(context: context, builder: (context) {
                        return AlertDialog(
                          actions: [
                            ...
                            TextButton(onPressed: () {
                              ...
                              BookingRepo().addToCart(BookingModel(
                                bookingName: singleProductVM.airlines?.airlineName ?? "",
                                bookingType: "Airlines",
                                imageUrl: singleProductVM.airlines!.imageUrl,
                          ...
                          content: Text("Are you sure you want to book ${singleProductVM.airlines!.airlineName}",style: TextStyle(fontSize: 20),),
                        );
                      },);
                    },
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Rs. " + singleProductVM.airlines!.price.toString(),
                            style: TextStyle(
                                fontSize: 30,
                                color: Colors.green,
                          ...
                          Text(
                            singleProductVM.airlines!.airlineName.toString(),
